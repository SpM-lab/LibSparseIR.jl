@testitem "Integration Test" tags=[:julia, :spir] begin
    ...
    function integration_test(::Type{T}, ::Type{S}, ::Type{K}, ndim::Int,
        ...
        # Tau Sampling
        @info "Tau sampling"
        tau_points = LibSparseIR.default_tau_sampling_points(basis)
        ...
        npoles = LibSparseIR.npoles(dlr)
        poles = LibSparseIR.get_poles(dlr)
    ...
    @testset "Integration Tests" begin
        for positive_only in [false, true]
            ...
            integration_test(Float64, LibSparseIR.Bosonic, LibSparseIR.LogisticKernel, 1,
                           beta, wmax, epsilon, extra_dims, 0, tol, positive_only)

            @info "Integration test for fermionic LogisticKernel"
            integration_test(Float64, LibSparseIR.Fermionic, LibSparseIR.LogisticKernel, 1,
                           beta, wmax, epsilon, extra_dims, 0, tol, positive_only)
