@testitem "MatsubaraFreq" tags=[:julia, :spir] begin
    using LibSparseIR
...
@testitem "Condition number" tags=[:julia, :spir] begin
    using LibSparseIR
...
@testitem "Kernel Accuracy Tests (Julia Wrapper)" tags=[:julia, :spir] begin
    using LibSparseIR
    using LibSparseIR: Λ
...
@testitem "FiniteTempBasis Constructor Tests (Julia Wrapper)" tags=[:julia, :spir] begin
    using LibSparseIR
...
@testitem "FiniteTempBasis Functions Tests (Julia Wrapper)" tags=[:julia, :spir] begin
    using LibSparseIR
